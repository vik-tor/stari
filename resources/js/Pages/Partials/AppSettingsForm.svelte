...
<Tabs {selectedId}>
    <TabList>
        <Tab id="first">Profile</Tab>
        <Tab id="second">Appearance</Tab>
        <Tab id="third">Data</Tab>
    </TabList>
    ...
    <TabPanel id="third">
        <form on:submit|preventDefault={uploadFile} class="w-4/5 mx-auto">
            ...
            >
                ...
                >
                <div
                    class="flex flex-col justify-center w-full max-w-lg mt-3 mb-2"
                >
                    ...
                    >
                        {#if $importForm.upload != null}
                            <div
                                class="flex flex-col justify-start text-xs p-2"
                            >
                        ...
                        {:else}
                            ...
                            >
                                ...
                                >
                                    JSON, TXT, or MD files (jrnl exports)
                                </p> -->
                            </div>
                        {/if}
                        ...
                        <input
                            ...
                            autocomplete="off"
                            on:input={(e) =>
                                ($importForm.upload = e.target.files[0])}
                        />
                    </label>
        ...
        <div class="w-4/5 mx-auto my-4">
            <button
                class="btn btn-accent btn-outline btn-block btn-sm ml-auto text-xs text-base-100 rounded justify-between capitalize"
            >
